...
def efetch_fasta_ncbi(protein_name, organism):
	print("Starting efetch_fasta_ncbi function")
	try:
		...
		print("Finished efetch_fasta_ncbi function")
...
def main():
	while True:
		try:
			...
			# Capture and print input validation errors
			print(ve)
		except Exception as e:
...
# Check if the script is running as the main program and call the main function
